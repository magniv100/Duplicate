...
from src.writers.rabbit_mq_writer import rabbit_mq_writer
from src.writers.s3_connect_dupe import upload_to_s3
from src.models.schema_management import validation
import logging
...
def insert_image(insert_req: InsertRequest, image: UploadFile):
    ...
    if metadata is not None:
        ...
        rabbit_mq_writer(image, metadata)
        logging.log(20, "writing to s3 store first...")
        upload_to_s3(image, metadata)
